...
const Comment = ()=>{
  ...
  <Wrapper>
    <CommentPreviewButton onClick={OpenComment}>
      <MoreCommentWrapper>
        <CommentItem comment={{nickname:'블라블라',createdAt:'2023-05-19T12:34:56Z',content:'댓그르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르르를'}}/>
        <MoreComment><MdOutlineKeyboardArrowRight size={20} /></MoreComment>
      </MoreCommentWrapper>
