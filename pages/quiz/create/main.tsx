              ...
              return (
                <SwiperSlide key={problemIndex}>
                  <S.QuizCreateCard>
                    ...
                    <S.ProblemTitleContainer>
                      <S.ProblemTitleInputBubble
                        type="text"
                        ...
                        <S.TextChoiceListContainer>
                          <>
                            ...
                            {problem.choices.length < 4 && (
                              <S.TextChoiceAddContainer as="div">
                                <input
                                  type="text"
