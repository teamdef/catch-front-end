...
const Page: NextPageWithLayout = () => {
  ...
  let userAnswers: string[] = userAns;
  ...
  let matchList = solveProblems.map((prob:any, index:number) => {
    ...
    if (result.cho_txt != userAns[index]) {
      return { title: prob.prob_title, user_answer: userAns[index], correct_answer: result.cho_txt };
    }
  });
  ...
  const moveResult = () => {
    ...
    // dispatch(
    //   saveSolveUserNameAction({ solveUserName: })
    // );
  };
